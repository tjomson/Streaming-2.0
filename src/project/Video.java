...
public class Video implements Playable {
    ...
    public VBox toVBox() throws TooOldVideoException{
        ...
        if (this instanceof Movie) {
            image = new Image(this.getClass().getResource("/FilmBilleder/" + this.getTitle() + ".jpg").toExternalForm());
        } else {
            image = new Image(this.getClass().getResource("/SerieBilleder/" + this.getTitle() + ".jpg").toExternalForm());
